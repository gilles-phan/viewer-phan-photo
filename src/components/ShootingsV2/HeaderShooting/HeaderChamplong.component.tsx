  ...
  <>
    <Col span={24}>
      ...
      <strong style={{ marginLeft: 16 }}>
        Option 1 - Paiement via mon site, réalisez le paiement via l'un des pack
        ci-dessous, envoyez moi un mail à{" "}
      ...
      <strong style={{ marginLeft: 16 }}>Option 2 - Paiement en magasin</strong>
      <ul style={{ marginLeft: 24 }}>
        <li>
          Payez chez PADD - Roanne, en espèce, par CB sans contact ou avec votre
          téléphone.
        </li>
...
export default HeaderChamplong;
